 ...
 * </ol>
 */
public class PoseGraphicOverlay extends View {
     ...
     * instances to the overlay using {@link PoseGraphicOverlay#add(Graphic)}.
     */
    public abstract static class Graphic {
        private PoseGraphicOverlay overlay;

        public Graphic(PoseGraphicOverlay overlay) {
    ...
    public PoseGraphicOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
