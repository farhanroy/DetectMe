...
import com.detect.me.utils.PreferenceUtils.getCameraPreviewSizePair
 ...
 */
class CameraSource(var activity: Activity, private val graphicOverlay: PoseGraphicOverlay) {
    ...
    private fun createCamera(): Camera {
        ...
        var sizePair: SizePair? = getCameraPreviewSizePair(activity, requestedCameraId)
        if (sizePair == null) {
